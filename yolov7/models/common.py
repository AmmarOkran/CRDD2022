...
class ASPP(nn.Module):
    def __init__(self, c1, c2,  atrous_rates=[3, 6, 9, 12]):
        ...
        modules.append(ASPPConv(c1, out_channels, 3))
        modules.append(ASPPConv(c1, out_channels, 6))
        modules.append(ASPPConv(c1, out_channels, 9))
        modules.append(ASPPConv(c1, out_channels, 12))
        # modules.append(ASPPConv(c1, out_channels, 18))
